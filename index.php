...
<form id="in-bar" method="get" action="" class="fill-barcode">
			<p style="margin-left: 2%;margin-top:50px;">
				<center><input style="position:relative;background-color:#F8F8FF;border-radius:5px;" type="text" name="dani" autofocus placeholder="Input Case"></center>
...
while($hasilcont = mysqli_fetch_array($cekcont)){
 ...
 $cekdo = mysqli_query($koneksi,"SELECT (no_do_cbu) AS do FROM tb_va_total_container_cbu ");
...
<button style="position:relative;margin-left:20px;"><a href="exsport-text.php"><h style="color:red;">Download Text</h></a></button>
<button style="position:relative;margin-left:20px;"><a href="exsport-excel.php"><h style="color:red;">Download Excel</h></a></button> 
<tr>
                        ...
                        <th class="d-none d-md-table-cell" style="color:white;" id="gradient3"><center>TANGGAL</center></th>
                            <th class="d-none d-md-table-cell" style="color:white;" id="gradient3"><center>JAM</center></th>
                            <th class="d-none d-md-table-cell" style="color:white;" id="gradient3"><center>BARCODE</center></th>
                            <th class="d-none d-md-table-cell" style="color:white;" id="gradient3"><center>CONTAINER</center></th>
                            <th class="d-none d-md-table-cell" style="color:white;" id="gradient3"><center>DO CBU</center></th>
                    ...
                    <?php
                      ...
                      $ambildata = mysqli_query($koneksi,"SELECT * FROM tb_va_input_cbu WHERE jamm >='07:00:00' and tgl ='$tanggal_ori' ");
                          ...
                          <tr>
                                  ...
                                  <td><a href="delete.php?id=<?php echo $tampil['id']; ?>">Delete</a></td></tr>        
...
?>
<button class="imga" style="position:relative;height:100px;width:250px;left:10px;top:-560px;border-radius:10px;color:white;"><a href="data_container_cbu.php" ><h2 style="color:black;"><b>ACT / PLAN CONT</b></h2><br><h1 style="color:black;font-size:45px;margin-top:-25px;"><b><?= $hasil; ?>/<?= $total_plan_container; ?></b></h1></a></button>
<button class="imga" style="position:relative;height:100px;width:250px;left:10px;top:-560px;border-radius:10px;color:white;"><a href="#" ><h2 style="color:blue;"><b>ACT EXIM</b></h2><br><h1 style="color:red;font-size:45px;margin-top:-25px;"><b style="color:green;"><?= $no_cont_exim; ?></b>/<b><?= $total_plan_containerexim; ?></b></h1></a></button>

<div style="position:relative;margin-left:1600px;top:-620px;"><a href="http://172.20.232.10/packing/dashboardppe/pilihan_vaning.php"><img style="border-radius:20px;" src="gambar/orb.gif" width="50px" height="50px;"></a>	</div>
